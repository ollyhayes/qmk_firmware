...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  //|------+------+------+------+------+------|                |------+------+------+------+------+------|
       KC_TRNS,      KC_Z,     KC_X,     KC_C,     KC_V,     KC_B,                      KC_N,     KC_M,  KC_COMM,   KC_DOT,  KC_SLSH,  KC_TRNS,\
  //|------+------+------+------+------+------+------|  |------+------+------+------+------+------+------|
                                  KC_TRNS, KC_TRNS,   KC_SPACE,      MO(ARR), KC_TRNS, KC_TRNS \
                              //`--------------------'  `--------------------'
  ),
  ...
  //|------+------+------+------+------+------|                ---+------+--------+------+------|
      KC_TRNS,MO(MEDIA),KC_4,KC_5,KC_6,KC_TRNS,          ALTTAB,KC_4,KC_5,KC_6,KC_TRNS,KC_TRNS,\
  //|------+------+------+------+------+------|                ---+------+--------+------+------|
  ...
  //|------+------+------+------+------+------|                                |------+------+------+------+------+------|
      DF(BASE),DF(GAMES),KC_TRNS,KC_TRNS,KC_TRNS,KC_TRNS,                KC_TRNS,KC_TRNS,KC_TRNS,KC_TRNS,KC_TRNS,KC_TRNS,\
  //|------+------+------+------+------+------+------|                  |------+------+------+------+------+------+------|
                                  KC_TRNS, KC_TRNS,                   KC_TRNS,      KC_TRNS, KC_TRNS, KC_TRNS \
                              //`--------------------'  `--------------------'
  ),
