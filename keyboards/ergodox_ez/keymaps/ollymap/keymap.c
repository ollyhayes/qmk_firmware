...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [BASE] = LAYOUT_ergodox(  // layer 0 : default
        ...
        KC_NO,      KC_K,     KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_RSFT,
                              MO(PUNC),KC_RCTRL,TG(EASY),KC_RGUI,KC_RCTRL,
        KC_F10,     KC_F11,
        KC_INS,
    ...
    [EASY] = LAYOUT_ergodox(  // layer 0 : default
        ...
        KC_LBRC,    KC_J,     KC_L,    KC_U,    KC_Y,    KC_SCLN, MO(FUNCTIONS),
                    KC_H,     KC_N,    KC_E,    KC_I,    KC_O,    KC_NO,
        KC_RBRC,    KC_K,     KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_RSFT,
                              MO(PUNC),RAND,    TG(EASY),KC_RGUI, KC_RCTRL,
        KC_F10,     KC_F11,
        KC_INS,
        KC_END,     KC_ENT,   KC_SPC
    ),
    ...
    [FUNCTIONS] = LAYOUT_ergodox(
       ...
       KC_TRNS,KC_TRNS,KC_F7,  KC_F8,  KC_F9,  C(KC_GRV),KC_TRNS,
       KC_TRNS,KC_TRNS,KC_F4,  KC_F5,  KC_F4,  CTLTAB,
       KC_TRNS,KC_TRNS,KC_F1,  KC_F2,  KC_F3,  SCTLTAB,KC_TRNS,
    ...
    [PUNC] = LAYOUT_ergodox(  // layer 0 : default
       ...
       KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,
        ...
        KC_TRNS, S(KC_QUOT),KC_LBRC,   KC_RBRC,    S(KC_MINS),KC_EQL, KC_TRNS,
                 KC_TRNS,   KC_TRNS,   KC_TRNS,    KC_TRNS, KC_TRNS,
        KC_TRNS, KC_TRNS,
        KC_TRNS,
        KC_TRNS, KC_TRNS,   KC_TRNS
